...
public class PatientController {
    ...
    public String bookAppointment(
        ...
        boolean exists =
                appointmentService.existsByDoctorAndAppointmentTime(doctor, dto.getAppointmentTime());
        if (dto.getId() != null &&
        ...
        redirectAttributes.addFlashAttribute(
                "success", dto.getId() != null ? "Cập nhật lịch khám thành công" : "Đặt lịch thành công");
        return "redirect:/patient/list";
    }
    ...
    public String patientHistory(HttpSession session, Model model) {
        ...
        List<MedicalRecord> records = medicalRecordService.getMedicalRecordsByPatient(user);
    ...
    public String patientList(HttpSession session,
        ...
        List<Appointment> appointments = appointmentService.getAppointmentsByPatient(user).stream()
